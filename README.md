...
data-quality issues, a Python cleaning pipeline, calculated KPIs, a Power BI dashboard, and a
live Streamlit dashboard.

**🔗 Live Demo:** [hedesk-dashboard.streamlit.app](https://hedesk-dashboard.streamlit.app/)
...
- **Streamlit** — live interactive KPI dashboard ([demo](https://hedesk-dashboard.streamlit.app/))
...
and writes `Tickets_Cleaned.xlsx`. `app.py` powers the [live dashboard](https://hedesk-dashboard.streamlit.app/).
...
| `app.py` | Streamlit dashboard — [live demo](https://hedesk-dashboard.streamlit.app/) |
